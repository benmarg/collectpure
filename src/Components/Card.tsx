    ...
    >
      <div className="flex flex-1 flex-col p-8">
        <img
          ...
          src={
            "https://www.usmint.gov/wordpress/wp-content/uploads/2021/02/2021-american-eagle-gold-one-ounce-proof-coin-obverse-old-design.jpg"
          }
          alt="Product Image"
        />
        ...
        <dl className="mt-1 flex flex-grow flex-col justify-between">
          ...
          <div className="flex items-center justify-between pt-1">
            <dd className="text-sm text-gray-500">
              {product.material.charAt(0) +
                product.material.slice(1).toLowerCase()}
            </dd>
          ...
          <dd className="mt-3">
            <span className="inline-flex items-center rounded-full bg-green-50 px-2 py-1 text-lg text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">
      ...
      <div>
        <div className="-mt-px flex divide-x divide-gray-200">
          <div className="flex w-0 flex-1 bg-green-100">
            <a
